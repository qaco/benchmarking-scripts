...
extern int polybench_papi_eventlist[];
...
#  undef polybench_stop_instruments
#  undef polybench_print_instruments
#  define polybench_start_instruments polybench_gem5_start();
#  define polybench_stop_instruments polybench_gem5_stop();
#  define polybench_print_instruments polybench_gem5_print();
extern void polybench_gem5_start();
extern void polybench_gem5_stop();
extern void polybench_gem5_print();
# endif
